...
public class IncomeTest {
    ...
    public void setUp() {
        ...
        driver.get("http://localhost:5173/incomes");
    ...
    @Test
    public void testIncomesPageLoadsCorrectly() {
        WebElement addButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("[data-testid='add-income-button']")
        ));
        ...
        WebElement expensesTable = driver.findElement(By.cssSelector("[data-testId='incomes-table-card']"));
        ...
        WebElement recurringExpensesTable = driver.findElement(By.cssSelector("[data-testId='recurring-incomes-table-card']"));
        assertTrue(recurringExpensesTable.isDisplayed(), "Tabela wydatków powinna być widoczna");
    }

    @Test
    public void testAddIncomeValidation() {
        WebElement addButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("[data-testid='add-income-button']")
        ));
        addButton.click();
    ...
    @Test
    public void testAddNewIncomeSuccessfully() {
        WebElement addButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.cssSelector("[data-testid='add-income-button']")
        ));
        addButton.click();
